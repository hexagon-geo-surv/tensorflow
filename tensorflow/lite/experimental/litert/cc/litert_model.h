...
using Dimensions = absl::InlinedVector<int32_t, kMaxExpectedTensorRank>;
using Strides = absl::InlinedVector<uint32_t, kMaxExpectedTensorRank>;
...
class Tensor : public internal::NonOwnedHandle<LiteRtTensor> {
 public:
  ...
  struct TensorUse;
  using TensorUses = absl::InlinedVector<TensorUse, kMaxExpectedTensorUses>;
...
using OpInputs = absl::InlinedVector<Tensor, kMaxExpectedOpInputs>;
using OpOutputs = absl::InlinedVector<Tensor, kMaxExpectedOpOutputs>;
...
using SubgraphInputs = absl::InlinedVector<Tensor, kMaxExpectedSubgraphInputs>;
using SubgraphOutputs =
    absl::InlinedVector<Tensor, kMaxExpectedSubgraphOutputs>;
