...
enum OptimizationHint : int32_t {
  ...
  OptimizationHint_OPTIMIZATION_BATCH_PROCESSOR = 4,
  OptimizationHint_MIN = OptimizationHint_OPTIMIZATION_NONE,
  OptimizationHint_MAX = OptimizationHint_OPTIMIZATION_BATCH_PROCESSOR
};
...
inline const OptimizationHint (&EnumValuesOptimizationHint())[4] {
  static const OptimizationHint values[] = {
    ...
    OptimizationHint_OPTIMIZATION_BATCH_PROCESSOR
  };
  return values;
}
...
inline const char *EnumNameOptimizationHint(OptimizationHint e) {
  if (::flatbuffers::IsOutRange(e, OptimizationHint_OPTIMIZATION_NONE, OptimizationHint_OPTIMIZATION_BATCH_PROCESSOR)) return "";
  const size_t index = static_cast<size_t>(e);
...
struct MtkNeuronSettings FLATBUFFERS_FINAL_CLASS : private ::flatbuffers::Table {
  ...
  uint32_t optimization_hint() const {
    return GetField<uint32_t>(VT_OPTIMIZATION_HINT, 0);
  }
  ...
  bool Verify(::flatbuffers::Verifier &verifier) const {
    return VerifyTableStart(verifier) &&
           VerifyField<int32_t>(verifier, VT_EXECUTION_PREFERENCE, 4) &&
           VerifyField<int32_t>(verifier, VT_EXECUTION_PRIORITY, 4) &&
           VerifyField<uint32_t>(verifier, VT_OPTIMIZATION_HINT, 4) &&
...
struct MtkNeuronSettingsBuilder {
  ...
  void add_optimization_hint(uint32_t optimization_hint) {
    fbb_.AddElement<uint32_t>(MtkNeuronSettings::VT_OPTIMIZATION_HINT, optimization_hint, 0);
  }
  ...
  void add_allow_fp16(bool allow_fp16) {
    fbb_.AddElement<uint8_t>(MtkNeuronSettings::VT_ALLOW_FP16, static_cast<uint8_t>(allow_fp16), 0);
  }
  ...
  void add_accelerator_name(::flatbuffers::Offset<::flatbuffers::String> accelerator_name) {
    fbb_.AddOffset(MtkNeuronSettings::VT_ACCELERATOR_NAME, accelerator_name);
  }
