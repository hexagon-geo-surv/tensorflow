...
// Get elements corresponding to slice starts from negative padding
// values.
DenseIntElementsAttr SliceStartFromNegPadLows(mhlo::PadOp op);

// Get elements corresponding to slice ends from negative padding
// values.
DenseIntElementsAttr SliceEndFromNegPadHighs(mhlo::PadOp op);

// Get a copy of `data` with negative values replaced with 0.
