...
func.func @testStackVersionPropagation(%arg0: tensor<1x4x4x1920xf32>) -> tensor<1x4x4x64xf32> {
  ...
  %1 = "tfl.conv_2d"(%arg0, %0, %cst) <{dilation_h_factor = 1 : i32, dilation_w_factor = 1 : i32, fused_activation_function = "NONE", padding = "VALID", stride_h = 1 : i32, stride_w = 1 : i32}> {tac.delegate_compiler_stack_version = "V_1_0", tac.device = "DARWINN", tac.inference_type = "HYBRID"} : (tensor<1x4x4x1920xf32>, tensor<64x1x1x1920x!quant.uniform<i8<-127:127>:f32, 0.002>>, tensor<64xf32>) -> tensor<1x4x4x64xf32>
  %2 = tfl.add %1, %1 {fused_activation_function = "NONE", tac.delegate_compiler_stack_version = "V_1_5", tac.device = "DARWINN", tac.inference_type = "FLOAT"} : tensor<1x4x4x64xf32>
...
// CHECK: return %[[RES1]]
// CHECK: }
// CHECK: func.func private @func_0_DARWINN_HYBRID(%arg0: tensor<1x4x4x1920xf32>, %arg1: tensor<64x1x1x1920x!quant.uniform<i8<-127:127>:f32, 2.000000e-03>>, %arg2: tensor<64xf32>) -> tensor<1x4x4x64xf32> attributes {tac.delegate_compiler_stack_version = "V_1_0", tac.device = "DARWINN", tac.inference_type = "HYBRID", tac.interface_name = "func_0"}
// CHECK: func.func private @func_1_DARWINN_FLOAT(%arg0: tensor<1x4x4x64xf32>) -> tensor<1x4x4x64xf32> attributes {tac.delegate_compiler_stack_version = "V_1_5", tac.device = "DARWINN", tac.inference_type = "FLOAT", tac.interface_name = "func_1"}
