...
// LINT.IfChange(kQuantizedValue8bit)
const int8_t kMinQuantizedValue8bit = -127;
const int8_t kMaxQuantizedValue8bit = 127;
// LINT.ThenChange(//tensorflow/lite/tools/optimize/quantization_utils.cc:kQuantizedValue8bit)

// LINT.IfChange(kQuantizedValue4bit)
const int8_t kMinQuantizedValue4bit = -7;
const int8_t kMaxQuantizedValue4bit = 7;
// LINT.ThenChange(//tensorflow/lite/tools/optimize/quantization_utils.cc:kQuantizedValue4bit)

// LINT.IfChange(kPerChannelMaxDim)
// The maximum number of dimensions supported in per-channel quantization.
constexpr int kPerChannelMaxDim = 4;
// LINT.ThenChange(//tensorflow/lite/tools/optimize/quantization_utils.cc:kPerChannelMaxDim)
}  // namespace

using absl::InternalError;
using tflite::BufferT;
using tflite::QuantizationParametersT;
using tflite::RuntimeShape;  // TFL dependency to remove
