...
#define GEN_PASS_DEF_TFSHAPEINFERENCEPASS
...
class ShapeInference : public impl::TFShapeInferencePassBase<ShapeInference> {
 public:
  ...
  void runOnOperation() override {
    ...
    if (!input_arg_shapes_.empty()) {
      auto parsed_shapes = ParseArgumentShapes(input_arg_shapes_);
      if (!parsed_shapes.ok()) {
