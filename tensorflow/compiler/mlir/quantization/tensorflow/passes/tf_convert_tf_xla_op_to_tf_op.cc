...
Value CreateSliceAndReshapeOpFromXlaGatherOpWithoutBatch(
  ...
  Value empty_start_indices = builder.create<TF::FillOp>(
      ...
      /*shape=*/quant::Create1DConstValue<int64_t>(
        builder, loc, {operand_rank}),
      /*value=*/quant::CreateScalarConstValue<int64_t>(builder, loc, 0));
  ...
  Value scattered_start_indices = builder.create<TF::TensorScatterUpdateOp>(
      ...
      builder.create<TF::ReshapeOp>(
          ...
          quant::Create1DConstValue<int64_t>(builder, loc, indices),
          quant::Create1DConstValue<int64_t>(builder, loc,
                                             {index_map_size, 1})),
      /*value=*/
  ...
  return builder.create<TF::ReshapeOp>(
      ...
      quant::Create1DConstValue(builder, loc, new_shape));
}
