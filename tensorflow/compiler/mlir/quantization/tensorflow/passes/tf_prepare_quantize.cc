...
void PrepareQuantizePass::SanityCheckAndAdjustment(func::FuncOp func) {
  ...
  // mlir::quant::ir::*QuantizeCastOp we're matching here.
  //
...
using PrepareQuantStats = ConvertStatsToQDQs<mlir::quant::ir::QuantizeCastOp,
...
void PrepareQuantizePass::runOnOperation() {
  ...
  patterns.add<ConvertUnsignedToSigned<mlir::quant::ir::QuantizeCastOp>>(ctx);
