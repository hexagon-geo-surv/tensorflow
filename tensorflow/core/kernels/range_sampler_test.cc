...
TEST_F(RangeSamplerTest, FixedUnigramDeathTest) {
  EXPECT_DEATH(new FixedUnigramSampler(9, 0.8, 0, 0, 0), "");
  EXPECT_DEATH(new FixedUnigramSampler(9, 0.8, 0, 1, -1), "");
  EXPECT_DEATH(new FixedUnigramSampler(9, 0.8, 0, 1, 1), "");
  EXPECT_DEATH(new FixedUnigramSampler(std::numeric_limits<int32_t>::max(), 0.8,
                                       0, 1, 0),
               "");
  EXPECT_DEATH(new FixedUnigramSampler(9, 0.8, -1, 1, 0), "");
  EXPECT_DEATH(new FixedUnigramSampler(9, 0.8, 10, 1, 0), "");
}
