...
def workspace():
    ...
    if "rules_ml_toolchain" not in native.existing_rules():
        http_archive(
            ...
            sha256 = "751fe4493c57659efcb7c670f16f1db257643d8e5ef936b6acfecbf30378be84",
            strip_prefix = "rules_ml_toolchain-2c9f8361218213eb833dbf8dd77535c6f7e7d676",
            urls = [
                "https://github.com/google-ml-infra/rules_ml_toolchain/archive/2c9f8361218213eb833dbf8dd77535c6f7e7d676.tar.gz",
            ],
        )
