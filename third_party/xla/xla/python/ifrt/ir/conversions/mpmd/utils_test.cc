...
INSTANTIATE_TEST_SUITE_P(
    ...
    testing::ValuesIn<ShardingParamConversionTestStruct>({
        ...
        {HloSharding::IotaTile({8, 1}, {4, 2}, {1, 0}),
         ...
         {"x", "y"},
         {4, 2}},
        {HloSharding::PartialTile(TileAssignment({4, 1, 2}, {8},
                                                                 {0})),
         {8, 4},
         {"x", "y"},
         {4, 2}},
        {HloSharding::PartialTile(
             TileAssignment({2, 1, 4}, {4, 2}, {1, 0})),
         {8, 4},
         {"x", "y"},
         {4, 2}},
        {HloSharding::PartialTile(TileAssignment({1, 4, 2}, {8},
                                                                 {0})),
         {8, 4},
         {"x", "y"},
         {4, 2}},
        {HloSharding::PartialTile(
             TileAssignment({1, 2, 4}, {4, 2}, {1, 0})),
         {8, 4},
         {"x", "y"},
         {4, 2}},
        {HloSharding::PartialTile(
         ...
         {2, 3, 4}},
        {HloSharding::PartialTile(
             TileAssignment({4, 2, 3}, {6, 4}, {1, 0})),
         {120, 96},
         {"x", "y", "z"},
         {2, 3, 4}},
        {HloSharding::PartialTile(TileAssignment({6, 1, 4},
                                                                 {24}, {0})),
         {120, 96},
         {"x", "y", "z"},
         {2, 3, 4}},
        {HloSharding::PartialTile(
             TileAssignment({12, 1, 2}, {2, 12}, {1, 0})),
         {120, 96},
         {"x", "y", "z"},
         {2, 3, 4}},
        {HloSharding::PartialTile(
             TileAssignment({8, 1, 3}, {6, 4}, {1, 0})),
         {120, 96},
         {"x", "y", "z"},
         {2, 3, 4}},
        {HloSharding::PartialTile(TileAssignment({2, 1, 12},
                                                                 {24}, {0})),
         {120, 96},
         {"x", "y", "z"},
         {2, 3, 4}},
        {HloSharding::PartialTile(
         ...
         {2, 3, 4}},
        {HloSharding::PartialTile(
             TileAssignment({1, 4, 6}, {6, 4}, {1, 0})),
         {120, 96},
         {"x", "y", "z"},
         {2, 3, 4}},
        {HloSharding::PartialTile(
             TileAssignment({1, 12, 2}, {2, 12}, {1, 0})),
         {120, 96},
         {"x", "y", "z"},
         {2, 3, 4}},
        {HloSharding::PartialTile(
        ...
        {HloSharding::PartialTile(
         ...
         {2, 3, 4}},
        {HloSharding::PartialTile(
             TileAssignment({12, 1, 1, 2}, {2, 12}, {1, 0})),
         {120, 96, 72},
         {"x", "y", "z"},
         {2, 3, 4}},
