...
// #include "third_party/py/numpy/_core/include/numpy/ndarraytypes.h"
// #include "third_party/py/numpy/_core/include/numpy/numpyconfig.h"
...
absl::Status PyArray::set_arrays(nb::object obj) {
  ...
  if (!nb::isinstance<nb::list>(obj)) {
    return absl::InvalidArgumentError(
        absl::StrCat("Unsupported arg when setting Array._arrays: ",
