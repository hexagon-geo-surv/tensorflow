...
// Populates Compute and Memory Utilization metrics.
// These are expected to be in the range [0.0, 1.0], but may exceed 1.0
// if the underlying time estimates are inaccurate.
