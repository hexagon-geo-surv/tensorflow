...
class GpuPerformanceModelWithIndexingAnalysis : public GpuPerformanceModelBase {
 public:
  ...
  // An overload of TryFindBestTilingForFusion that returns the top_k
  // (possibly fewer if not enough valid tilings are found) block level
  // parameters for the given fusion.
  absl::StatusOr<TopKTiledRunTimeDataOrError> TryFindBestTilingForFusion(
