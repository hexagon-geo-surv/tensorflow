...
TEST_F(ConstraintExpressionTest,
  ...
  EXPECT_EQ(constraints.ToString(), "always satisfied\n");
}
...
TEST_F(ConstraintExpressionTest, CanSimplifyUnsatisfiableContraintExpression) {
  ...
  EXPECT_EQ(constraints.ToString(), "unsatisfiable\n");
}
...
TEST_F(ConstraintExpressionTest,
  ...
  EXPECT_EQ(constraints.ToString(), "d0 in [0, 2) && d1 in [0, 2)\n");
}
...
TEST_F(ConstraintExpressionTest,
  ...
  EXPECT_EQ(constraints.ToString(), "d0 in [0, 2)\n");
}
