...
// `input_keys`.
TEST_F(SortRewriterTest, SortPairsCanBeSimplifiedToSortKeys) {
  constexpr char kHlo[] = R"(
HloModule TestModule
...
TEST_F(SortRewriterTest, SortPairsSwappedCanBeSimlifiedToSortKeys) {
  constexpr char kHlo[] = R"(
HloModule TestModule
...
// Sort a pair of tensors (values, indices generated by iota) with a complex
// compare. Same as SortPairsIotaComparerSimple, but because the `input_values`
// operand is unused, we can simplify it and sort only `input_keys`.
TEST_F(SortRewriterTest, SortPairsIotaComparerSimpleCanBeSimplifiedToSortKeys) {
  constexpr char kHlo[] = R"(
HloModule TestModule
