...
void PrintDimVars(mlir::AsmPrinter& p,
                  mlir::ArrayRef<::xla::gpu::DimVar> dim_vars);

mlir::FailureOr<llvm::SmallVector<::xla::gpu::DimVar>> ParseDimVars(
    mlir::AsmParser& parser);

void PrintRangeVars(mlir::AsmPrinter& p,
                    mlir::ArrayRef<::xla::gpu::RangeVar> range_vars);

mlir::FailureOr<llvm::SmallVector<::xla::gpu::RangeVar>> ParseRangeVars(
    mlir::AsmParser& parser);
