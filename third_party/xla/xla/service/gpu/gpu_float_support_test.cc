...
class FloatSupportTest : public HloTestBase {
 protected:
  ...
  bool Normalize(HloModule* module, se::GpuComputeCapability cc,
                 ...
                 PrimitiveType high_precision_type, bool fallback_only) {
  ...
  void TestDotConversion(PrimitiveType lhs_type, PrimitiveType rhs_type,
                         ...
                         bool fallback_only, bool should_convert_lhs,
    ...
    EXPECT_EQ(Normalize(module.get(), cc, low_precision_type,
                        high_precision_type, fallback_only),
...
TEST_F(FloatSupportTest, Fp8DotHopperF8E4M3FN_Fallback_F16) {
  TestDotConversion(F8E4M3FN, F8E4M3FN, F16,
                    se::CudaComputeCapability::Hopper(),
                    /*fallback_only=*/true,
...
TEST_F(FloatSupportTest, Fp8DotHopperMixedFp8_Fallback_F32) {
  TestDotConversion(F8E5M2, F8E4M3FN, F32, se::CudaComputeCapability::Hopper(),
                    /*fallback_only=*/true,
                    /*should_convert_lhs=*/true,
                    /*should_convert_rhs=*/false, F8E5M2);
