...
class BufferIntervalTree {
 public:
  ...
  //
  // Memory map for time: [18,23], best_memory_block: 16, group_size: 3
  //
  // ... ##. 64
  // ##. ##. 48
  // ##. ##. 32
  ...
  // 890 123     indicates time 18, 19, ..., 23 (only last digit will be output)
  //
  // `group_size=3` inserts spaces after every 3 columns (time steps).
