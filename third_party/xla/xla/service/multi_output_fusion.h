...
class MultiOutputFusion : public HloModulePass {
 ...
 private:
  ...
  // Update the internal data structures before fused is fused into fusion.
  ...
  std::vector<uintptr_t> update_worklist_;
  std::vector<HloReachabilityMap::Index> indices_to_update_;
