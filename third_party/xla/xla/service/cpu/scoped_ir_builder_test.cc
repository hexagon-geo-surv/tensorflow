...
using IrEmitterScopedBuilderTest = HloTestBase;

TEST_F(IrEmitterScopedBuilderTest, OverwriteBuilder) {
  llvm::LLVMContext context;
  IrEmitter ir_emitter = [this, &context]() {
    // Construct an IR emitter.
    ...
    return IrEmitter(/*mlir_context=*/nullptr, *hlo, *buffer_assignment,
                     module.get(), /*instruction_to_profile_idx=*/{},
