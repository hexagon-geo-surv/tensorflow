...
func.func @single_manual_comp(%arg0: tensor<8x16xf32> {sdy.sharding = #sdy.sharding<@mesh_0, [{"a", ?}, {"b", ?}]>}, %arg1: tensor<16x32xf32> {sdy.sharding = #sdy.sharding<@mesh_0, [{"b", ?}, {?}]>}) -> (tensor<8x32xf32> {sdy.sharding = #sdy.sharding<@mesh_0, [{"a"}, {}]>}) {
  // CHECK-NEXT: %0 = mhlo.copy %arg0 {sdy.sharding = #sdy.sharding_per_value<[<@mesh_0, [{"a"}, {"b"}]>]>, xla.sdy.manual_axes = #sdy<manual_axes{}>} : tensor<8x16xf32>
  ...
  // CHECK-NEXT: %2 = mhlo.copy %arg1 {sdy.sharding = #sdy.sharding_per_value<[<@mesh_0, [{"b"}, {}], replicated={"a"}>]>, xla.sdy.manual_axes = #sdy<manual_axes{}>} : tensor<16x32xf32>
  ...
  // CHECK-NEXT: %8 = stablehlo.custom_call @SPMDShardToFullShape(%7) {sdy.sharding = #sdy.sharding_per_value<[<@mesh_0, [{"a"}, {}], replicated={"b"}>]>, xla.sdy.manual_axes = #sdy<manual_axes{}>} : (tensor<2x32xf32>) -> tensor<8x32xf32>
...
func.func @manual_comp_using_another(%arg0: tensor<8x8xf32> {sdy.sharding = #sdy.sharding<@mesh_0, [{"a"}, {}]>})
  ...
  // CHECK-NEXT: %0 = mhlo.copy %arg0 {sdy.sharding = #sdy.sharding_per_value<[<@mesh_0, [{"a"}, {}]>]>, xla.sdy.manual_axes = #sdy<manual_axes{}>} : tensor<8x8xf32>
  ...
  // CHECK-NEXT: %3 = stablehlo.custom_call @SPMDShardToFullShape(%2) {sdy.sharding = #sdy.sharding_per_value<[<@mesh_0, [{"a"}, {}]>]>, xla.sdy.manual_axes = #sdy<manual_axes{}>} : (tensor<2x8xf32>) -> tensor<8x8xf32>
  // CHECK-NEXT: %4 = mhlo.copy %3 {sdy.sharding = #sdy.sharding_per_value<[<@mesh_0, [{}, {"b"}]>]>, xla.sdy.manual_axes = #sdy<manual_axes{}>} : tensor<8x8xf32>
  ...
  // CHECK-NEXT: %7 = stablehlo.custom_call @SPMDShardToFullShape(%6) {sdy.sharding = #sdy.sharding_per_value<[<@mesh_0, [{}, {"b"}]>]>, xla.sdy.manual_axes = #sdy<manual_axes{}>} : (tensor<8x4xf32>) -> tensor<8x8xf32>
...
func.func @sharding_in_manual_computation_body(%arg0: tensor<8x16xf32> {sdy.sharding = #sdy.sharding<@mesh_1, [{"a", ?}, {"b", ?}]>}, %arg1: tensor<16x32xf32> {sdy.sharding = #sdy.sharding<@mesh_1, [{"b", ?}, {?}]>}) -> (tensor<8x32xf32> {sdy.sharding = #sdy.sharding<@mesh_1, [{"a"}, {}]>}) {
  // CHECK-NEXT: %0 = mhlo.copy %arg0 {sdy.sharding = #sdy.sharding_per_value<[<@mesh_1, [{"a"}, {"b"}]>]>, xla.sdy.manual_axes = #sdy<manual_axes{}>} : tensor<8x16xf32>
  ...
  // CHECK-NEXT: %2 = mhlo.copy %arg1 {sdy.sharding = #sdy.sharding_per_value<[<@mesh_1, [{"b"}, {}], replicated={"a"}>]>, xla.sdy.manual_axes = #sdy<manual_axes{}>} : tensor<16x32xf32>
  ...
  // CHECK-NEXT: %7 = stablehlo.custom_call @SPMDShardToFullShape(%6) {sdy.sharding = #sdy.sharding_per_value<[<@mesh_1, [{"a"}, {}], replicated={"b"}>]>, xla.sdy.manual_axes = #sdy<manual_axes{}>} : (tensor<4x32xf32>) -> tensor<8x32xf32>
...
func.func @nested_shmaps(%arg0: tensor<4x8x16xf32> {sdy.sharding = #sdy.sharding<@mesh_1, [{"a"}, {"b"}, {"c"}]>}) -> (tensor<4x8x16xf32> {sdy.sharding = #sdy.sharding<@mesh_1, [{"a", ?}, {?}, {?}]>}) {
  // CHECK-NEXT: %0 = mhlo.copy %arg0 {sdy.sharding = #sdy.sharding_per_value<[<@mesh_1, [{"a"}, {}, {}]>]>, xla.sdy.manual_axes = #sdy<manual_axes{}>} : tensor<4x8x16xf32>
  ...
  // CHECK-NEXT: %12 = stablehlo.custom_call @SPMDShardToFullShape(%11) {sdy.sharding = #sdy.sharding_per_value<[<@mesh_1, [{"a"}, {}, {}]>]>, xla.sdy.manual_axes = #sdy<manual_axes{}>} : (tensor<2x8x16xf32>) -> tensor<4x8x16xf32>
...
func.func @nested_shmaps_extra_op(%arg0: tensor<4x8xf32> {sdy.sharding = #sdy.sharding<@mesh_1, [{"a"}, {"b"}]>}) -> (tensor<4x8xf32> {sdy.sharding = #sdy.sharding<@mesh_1, [{"a", ?}, {?}]>}) {
  // CHECK-NEXT: %0 = mhlo.copy %arg0 {sdy.sharding = #sdy.sharding_per_value<[<@mesh_1, [{"a"}, {}]>]>, xla.sdy.manual_axes = #sdy<manual_axes{}>} : tensor<4x8xf32>
  ...
  // CHECK-NEXT: %11 = stablehlo.custom_call @SPMDShardToFullShape(%10) {sdy.sharding = #sdy.sharding_per_value<[<@mesh_1, [{"a"}, {}]>]>, xla.sdy.manual_axes = #sdy<manual_axes{}>} : (tensor<2x8xf32>) -> tensor<4x8xf32>
...
func.func @multiple_manual_computation_uses(%arg0: tensor<2x4x8xi32> {sdy.sharding = #sdy.sharding<@mesh_0, [{}, {}, {"a"}]>}, %arg1: tensor<32x16x8xi32> {sdy.sharding = #sdy.sharding<@mesh_0, [{}, {}, {"a"}]>}) -> (tensor<131x4x8xi32> {sdy.sharding = #sdy.sharding<@mesh_0, [{?}, {?}, {"a"}]>}) {
  // CHECK-NEXT: %0 = mhlo.copy %arg0 {sdy.sharding = #sdy.sharding_per_value<[<@mesh_0, [{}, {}, {"a"}]>]>, xla.sdy.manual_axes = #sdy<manual_axes{}>} : tensor<2x4x8xi32>
  ...
  // CHECK-NEXT: %4 = stablehlo.custom_call @SPMDShardToFullShape(%3) {sdy.sharding = #sdy.sharding_per_value<[<@mesh_0, [{}, {}, {"a"}]>]>, xla.sdy.manual_axes = #sdy<manual_axes{}>} : (tensor<3x4x2xi32>) -> tensor<3x4x8xi32>
  // CHECK-NEXT: %5 = mhlo.copy %arg1 {sdy.sharding = #sdy.sharding_per_value<[<@mesh_0, [{}, {}, {"a"}]>]>, xla.sdy.manual_axes = #sdy<manual_axes{}>} : tensor<32x16x8xi32>
  ...
  // CHECK-NEXT: %9 = stablehlo.custom_call @SPMDShardToFullShape(%8) {sdy.sharding = #sdy.sharding_per_value<[<@mesh_0, [{}, {}, {"a"}]>]>, xla.sdy.manual_axes = #sdy<manual_axes{}>} : (tensor<128x4x2xi32>) -> tensor<128x4x8xi32>
  // CHECK-NEXT: %10 = mhlo.copy %4 {sdy.sharding = #sdy.sharding_per_value<[<@mesh_0, [{}, {}, {"a"}]>]>, xla.sdy.manual_axes = #sdy<manual_axes{}>} : tensor<3x4x8xi32>
  ...
  // CHECK-NEXT: %12 = mhlo.copy %9 {sdy.sharding = #sdy.sharding_per_value<[<@mesh_0, [{}, {}, {"a"}]>]>, xla.sdy.manual_axes = #sdy<manual_axes{}>} : tensor<128x4x8xi32>
  ...
  // CHECK-NEXT: %16 = stablehlo.custom_call @SPMDShardToFullShape(%15) {sdy.sharding = #sdy.sharding_per_value<[<@mesh_0, [{}, {}, {"a"}]>]>, xla.sdy.manual_axes = #sdy<manual_axes{}>} : (tensor<131x4x2xi32>) -> tensor<131x4x8xi32>
...
func.func @remove_auto_axes_to_avoid_padding(%arg0: tensor<4xf32>, %arg1: tensor<12xf32>, %arg2: tensor<24xf32>, %arg3: tensor<48xf32>, %arg4: tensor<96xf32>, %arg5: tensor<192xf32>) -> (tensor<4xf32>, tensor<12xf32>, tensor<24xf32>, tensor<48xf32>, tensor<96xf32>, tensor<192xf32>) {
  // CHECK-NEXT: %0 = mhlo.copy %arg0 {sdy.sharding = #sdy.sharding_per_value<[<@mesh_2, [{"a"}]>]>, xla.sdy.manual_axes = #sdy<manual_axes{}>} : tensor<4xf32>
  ...
  // CHECK-NEXT: %2 = mhlo.copy %arg1 {sdy.sharding = #sdy.sharding_per_value<[<@mesh_2, [{"a"}]>]>, xla.sdy.manual_axes = #sdy<manual_axes{}>} : tensor<12xf32>
  ...
  // CHECK-NEXT: %4 = mhlo.copy %arg2 {sdy.sharding = #sdy.sharding_per_value<[<@mesh_2, [{"a", "b":(1)2}]>]>, xla.sdy.manual_axes = #sdy<manual_axes{}>} : tensor<24xf32>
  ...
  // CHECK-NEXT: %6 = mhlo.copy %arg3 {sdy.sharding = #sdy.sharding_per_value<[<@mesh_2, [{"a", "b"}]>]>, xla.sdy.manual_axes = #sdy<manual_axes{}>} : tensor<48xf32>
  ...
  // CHECK-NEXT: %8 = mhlo.copy %arg4 {sdy.sharding = #sdy.sharding_per_value<[<@mesh_2, [{"a", "b", "c":(1)2}]>]>, xla.sdy.manual_axes = #sdy<manual_axes{}>} : tensor<96xf32>
  ...
  // CHECK-NEXT: %10 = mhlo.copy %arg5 {sdy.sharding = #sdy.sharding_per_value<[<@mesh_2, [{"a", "b", "c"}]>]>, xla.sdy.manual_axes = #sdy<manual_axes{}>} : tensor<192xf32>
  ...
  // CHECK-NEXT: %13 = stablehlo.custom_call @SPMDShardToFullShape(%12) {sdy.sharding = #sdy.sharding_per_value<[<@mesh_2, [{"a"}]>]>, xla.sdy.manual_axes = #sdy<manual_axes{}>} : (tensor<1xf32>) -> tensor<4xf32>
  // CHECK-NEXT: %14 = mhlo.copy %3 {sdy.sharding = #sdy.sharding_per_value<[<@mesh_2, [{}]>]>, xla.sdy.manual_axes = #sdy<manual_axes{"a"}>} : tensor<3xf32>
  // CHECK-NEXT: %15 = stablehlo.custom_call @SPMDShardToFullShape(%14) {sdy.sharding = #sdy.sharding_per_value<[<@mesh_2, [{"a"}]>]>, xla.sdy.manual_axes = #sdy<manual_axes{}>} : (tensor<3xf32>) -> tensor<12xf32>
  ...
  // CHECK-NEXT: %17 = stablehlo.custom_call @SPMDShardToFullShape(%16) {sdy.sharding = #sdy.sharding_per_value<[<@mesh_2, [{"a", "b":(1)2}]>]>, xla.sdy.manual_axes = #sdy<manual_axes{}>} : (tensor<6xf32>) -> tensor<24xf32>
  ...
  // CHECK-NEXT: %19 = stablehlo.custom_call @SPMDShardToFullShape(%18) {sdy.sharding = #sdy.sharding_per_value<[<@mesh_2, [{"a", "b"}]>]>, xla.sdy.manual_axes = #sdy<manual_axes{}>} : (tensor<12xf32>) -> tensor<48xf32>
  ...
  // CHECK-NEXT: %21 = stablehlo.custom_call @SPMDShardToFullShape(%20) {sdy.sharding = #sdy.sharding_per_value<[<@mesh_2, [{"a", "b", "c":(1)2}]>]>, xla.sdy.manual_axes = #sdy<manual_axes{}>} : (tensor<24xf32>) -> tensor<96xf32>
  ...
  // CHECK-NEXT: %23 = stablehlo.custom_call @SPMDShardToFullShape(%22) {sdy.sharding = #sdy.sharding_per_value<[<@mesh_2, [{"a", "b", "c"}]>]>, xla.sdy.manual_axes = #sdy<manual_axes{}>} : (tensor<48xf32>) -> tensor<192xf32>
...
// CHECK-NEXT: %0 = mhlo.copy %arg0 {sdy.sharding = #sdy.sharding_per_value<[<@mesh_0, [{"a", "b"}]>]>, xla.sdy.manual_axes = #sdy<manual_axes{}>} : tensor<32xi32>
...
// CHECK-NEXT: %5 = stablehlo.custom_call @SPMDShardToFullShape(%4) {sdy.sharding = #sdy.sharding_per_value<[<@mesh_0, [{"a", "b"}]>]>, xla.sdy.manual_axes = #sdy<manual_axes{}>} : (tensor<8xi32>) -> tensor<32xi32>
...
// CHECK-NEXT: %7 = stablehlo.custom_call @SPMDShardToFullShape(%6) {sdy.sharding = #sdy.sharding_per_value<[<@mesh_0, [{"a", "b"}]>]>, xla.sdy.manual_axes = #sdy<manual_axes{}>} : (tensor<8xi32>) -> tensor<32xi32>
// CHECK-NEXT: %8 = mhlo.copy %3 {sdy.sharding = #sdy.sharding_per_value<[<@mesh_0, [{"b"}]>]>, xla.sdy.manual_axes = #sdy<manual_axes{"a"}>} : tensor<4xi32>
// CHECK-NEXT: %9 = stablehlo.custom_call @SPMDShardToFullShape(%8) {sdy.sharding = #sdy.sharding_per_value<[<@mesh_0, [{"a", "b"}]>]>, xla.sdy.manual_axes = #sdy<manual_axes{}>} : (tensor<4xi32>) -> tensor<16xi32>
