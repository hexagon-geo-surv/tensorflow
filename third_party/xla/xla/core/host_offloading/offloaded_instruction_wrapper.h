...
#ifndef XLA_CORE_HOST_OFFLOADING_OFFLOADED_INSTRUCTION_WRAPPER_H_
#define XLA_CORE_HOST_OFFLOADING_OFFLOADED_INSTRUCTION_WRAPPER_H_
...
#endif  // XLA_CORE_HOST_OFFLOADING_OFFLOADED_INSTRUCTION_WRAPPER_H_
