...
Root tiles:
0 root tile:  offsets [tid_0 * 1, tid_1 * 2] sizes [1, 2] strides [1, 1] upper bounds [4, 16]

Tiled HLO:
  dot.tile_0 = dot(p0.1.tile_0, p1.1.tile_0)  offsets [tid_0 * 1, tid_1 * 2] sizes [1, 2] strides [1, 1] upper bounds [4, 16]
  region #0 {
    p0.1.tile_0 = parameter()  offsets [tid_0 * 1, tid_2 * 4] sizes [1, 4] strides [1, 1] upper bounds [4, 8]
