...
#define GEN_PASS_DEF_STABLEHLOEXPANDTUPLEPASS
...
class StablehloExpandTuplePass
    : public impl::StablehloExpandTuplePassBase<StablehloExpandTuplePass> {
 public:
  StablehloExpandTuplePass()
      : StablehloExpandTuplePassBase<StablehloExpandTuplePass>() {}
  explicit StablehloExpandTuplePass(const StablehloExpandTuplePassOptions &opts)
      : StablehloExpandTuplePassBase<StablehloExpandTuplePass>(opts) {}
