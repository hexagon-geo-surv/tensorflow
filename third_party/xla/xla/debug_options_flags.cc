...
DebugOptions DefaultDebugOptionsIgnoringFlags() {
  ...
  opts.set_xla_gpu_print_minmax(false);
...
void MakeDebugOptionsFlags(std::vector<tsl::Flag>* flag_list,
  ...
  flag_list->push_back(
      tsl::Flag("xla_gpu_print_minmax",
                bool_setter_for(&DebugOptions::set_xla_gpu_print_minmax),
                debug_options->xla_gpu_print_minmax(),
                "If true, print min/max values from kernel outputs."));
