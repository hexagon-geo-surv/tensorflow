...
XLA_TEST_F(CollectiveOpsTest,
  ...
  while_body {
    ...
    matmul = f32[2,2] dot(data, weights), lhs_contracting_dims={0}, rhs_contracting_dims={1}
  ...
  LiteralTestUtil::ExpectR2Equal<float>({{0, 0}, {0, 2}}, results[0]);
  LiteralTestUtil::ExpectR2Equal<float>({{0, 0}, {0, 3}}, results[1]);
  LiteralTestUtil::ExpectR2Equal<float>({{0, 0}, {0, 4}}, results[2]);
  LiteralTestUtil::ExpectR2Equal<float>({{0, 0}, {0, 1}}, results[3]);
}
