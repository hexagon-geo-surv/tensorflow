...
XLA_TEST_F(ConvolutionTest, Convolve1D_3x2x5_1x2x2_WithLHSDilation) {
  XlaBuilder builder(TestName());
  {
  ...
  Array3D<float> expected({{{190, 320, 230, 380, 270, 440, 310, 500}},
                           {{1900, 3200, 2300, 3800, 2700, 4400, 3100, 5000}},
                           {{380, 640, 460, 760, 540, 880, 620, 1000}}});
...
XLA_TEST_F(ConvolutionTest, Convolve1D_3x2x5_2x2x2_WithLHSDilation) {
  XlaBuilder builder(TestName());
  {
    Shape input_shape = ShapeUtil::MakeShape(F32, {3, 2, 5});
  ...
  Array3D<float> filter({{{10, 20}, {30, 40}}, {{11, 22}, {33, 44}}});

  Array3D<float> expected({{{190, 320, 230, 380, 270, 440, 310, 500},
                            {209, 352, 253, 418, 297, 484, 341, 550}},
                           {{1900, 3200, 2300, 3800, 2700, 4400, 3100, 5000},
                            {2090, 3520, 2530, 4180, 2970, 4840, 3410, 5500}},
                           {{380, 640, 460, 760, 540, 880, 620, 1000},
                            {418, 704, 506, 836, 594, 968, 682, 1100}}});
