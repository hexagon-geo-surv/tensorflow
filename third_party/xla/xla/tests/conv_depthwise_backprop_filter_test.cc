...
XLA_TEST_F(HloTestBase, DepthwiseBatchOuterDot) {
  const std::string hlo_string = R"(
HloModule main, entry_computation_layout={(f32[16,30,1,64,5]{3,0,2,1,4},f32[16,30,30,64,3]{3,0,2,1,4})->f32[30,30,64,1,11]{2,3,1,0,4}}

ENTRY main {
  p0 = f32[16,30,1,64,5] parameter(0)
  p1 = f32[16,30,30,64,3] parameter(1)
