...
#ifndef XLA_TSL_UTIL_ZIP_WRITER_H_
#define XLA_TSL_UTIL_ZIP_WRITER_H_
...
class ZipWriter {
 public:
  ...
  // using raw DEFLATE.
  absl::Status AddFile(absl::string_view name, absl::string_view content);
...
#endif  // XLA_TSL_UTIL_ZIP_WRITER_H_
