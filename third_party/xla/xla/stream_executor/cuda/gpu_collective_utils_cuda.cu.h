...
#ifndef XLA_STREAM_EXECUTOR_CUDA_GPU_COLLECTIVE_UTILS_CUDA_CU_H_
#define XLA_STREAM_EXECUTOR_CUDA_GPU_COLLECTIVE_UTILS_CUDA_CU_H_
...
#endif  // XLA_STREAM_EXECUTOR_CUDA_GPU_COLLECTIVE_UTILS_CUDA_CU_H_
