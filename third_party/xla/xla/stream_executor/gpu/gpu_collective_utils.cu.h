...
#ifndef XLA_STREAM_EXECUTOR_GPU_GPU_COLLECTIVE_UTILS_CU_H_
#define XLA_STREAM_EXECUTOR_GPU_GPU_COLLECTIVE_UTILS_CU_H_
...
#endif  // XLA_STREAM_EXECUTOR_GPU_GPU_COLLECTIVE_UTILS_CU_H_
