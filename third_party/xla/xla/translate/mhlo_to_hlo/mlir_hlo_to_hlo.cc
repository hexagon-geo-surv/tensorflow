...
LogicalResult ExportXlaOp(WhileOp op, OpLoweringContext ctx) {
  ...
  llvm::SmallVector<mlir::Value> implicit_operands(implicit_operand_set.begin(),
                                                   implicit_operand_set.end());
  ...
  // arguments, as they are carried over to the next iteration. This, we pass
