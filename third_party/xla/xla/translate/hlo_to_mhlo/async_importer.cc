...
StatusOr<mlir::Operation*> ImportSend(
...
StatusOr<mlir::Operation*> ImportRecv(
    const HloInstruction* instruction, mlir::Location loc,
    const llvm::SmallVectorImpl<mlir::Value>& operands,
    llvm::SmallVectorImpl<mlir::NamedAttribute>& attributes,
    mlir::Type result_type, mlir::OpBuilder* builder,
  ...
  bool is_empty_result = IsEmptyTuple(result_types[0]);
  llvm::SmallVector<mlir::Type> op_result_types;
  if (!is_empty_result) {
    op_result_types.push_back(result_types[0]);
  }
  op_result_types.push_back(result_types[2]);
  auto recv = builder->create<mlir::mhlo::RecvOp>(loc, op_result_types,
                                                  operands, attributes);
  // To keep parity, if op only returns token, wrap in tuple<tuple<>, token>
  if (is_empty_result) {
    auto empty_tuple = builder->create<mlir::mhlo::TupleOp>(
        loc, llvm::ArrayRef<mlir::Value>{});
    return builder->create<mlir::mhlo::TupleOp>(
        loc, llvm::ArrayRef<mlir::Value>{empty_tuple.getResult(),
                                         recv.getResult(0)});
  }
...
StatusOr<mlir::Operation*> ImportAllGatherStart(
    const HloInstruction* instruction, mlir::Location loc,
    const llvm::SmallVectorImpl<mlir::Value>& operands,
    llvm::SmallVectorImpl<mlir::NamedAttribute>& attributes,
    mlir::Type result_type, mlir::OpBuilder* builder,
...
StatusOr<mlir::Operation*> ImportAllReduceStart(
    const HloInstruction* instruction, mlir::Location loc,
    const llvm::SmallVectorImpl<mlir::Value>& operands,
    llvm::SmallVectorImpl<mlir::NamedAttribute>& attributes,
    mlir::Type result_type, mlir::OpBuilder* builder,
...
StatusOr<mlir::Operation*> ImportCollectivePermuteStart(
    const HloInstruction* instruction, mlir::Location loc,
    const llvm::SmallVectorImpl<mlir::Value>& operands,
    llvm::SmallVectorImpl<mlir::NamedAttribute>& attributes,
    mlir::Type result_type, mlir::OpBuilder* builder,
...
StatusOr<mlir::Operation*> ImportCopyStart(
    const HloInstruction* instruction, mlir::Location loc,
    const llvm::SmallVectorImpl<mlir::Value>& operands,
    llvm::SmallVectorImpl<mlir::NamedAttribute>& attributes,
    mlir::Type result_type, mlir::OpBuilder* builder,
...
StatusOr<mlir::Operation*> ImportAsyncOpDone(
    const HloInstruction* instruction, mlir::Location loc,
    const llvm::SmallVectorImpl<mlir::Value>& operands,
    llvm::SmallVectorImpl<mlir::NamedAttribute>& attributes,
    mlir::Type result_type, mlir::OpBuilder* builder,
