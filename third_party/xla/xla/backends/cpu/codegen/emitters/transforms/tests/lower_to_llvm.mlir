...
// CHECK: %[[WORKGROUP_X_GEP:.+]] = llvm.getelementptr inbounds %2[0, 0] : (!llvm.ptr) -> !llvm.ptr, !llvm.struct<"kernel_dim3", (i64, i64, i64)>
// CHECK: %[[WORKGROUP_X:.+]] = llvm.load %[[WORKGROUP_X_GEP]] invariant : !llvm.ptr -> i64
// CHECK: %[[WORKGROUP_X_IDX:.+]] = builtin.unrealized_conversion_cast %4 : i64 to index
// CHECK: %[[WORKGROUP_Y_GEP:.+]] = llvm.getelementptr inbounds %2[0, 1] : (!llvm.ptr) -> !llvm.ptr, !llvm.struct<"kernel_dim3", (i64, i64, i64)>
// CHECK: %[[WORKGROUP_Y:.+]] = llvm.load %6 invariant : !llvm.ptr -> i64
// CHECK: %[[WORKGROUP_Y_IDX:.+]] = builtin.unrealized_conversion_cast %[[WORKGROUP_Y]] : i64 to index
// CHECK: %[[WORKGROUP_Z_GEP:.+]] = llvm.getelementptr inbounds %2[0, 2] : (!llvm.ptr) -> !llvm.ptr, !llvm.struct<"kernel_dim3", (i64, i64, i64)>
// CHECK: %[[WORKGROUP_Z:.+]] = llvm.load %9 invariant : !llvm.ptr -> i64
// CHECK: %[[WORKGROUP_Z_IDX:.+]] = builtin.unrealized_conversion_cast %10 : i64 to index
