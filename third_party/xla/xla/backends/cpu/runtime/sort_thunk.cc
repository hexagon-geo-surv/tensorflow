...
static absl::Status SortInplace(
  ...
  for (int64_t i = 0; i < sort_dims.num_iterations; ++i) {
    ...
    auto builtin_sort = [&](PrimitiveType type,
      ...
      switch (type) {
        case S8:
          SortPlainArrayInplace<S8>(sort_dims, data, is_stable, direction);
          break;
        case S16:
          SortPlainArrayInplace<S16>(sort_dims, data, is_stable, direction);
          break;
        case S32:
          SortPlainArrayInplace<S32>(sort_dims, data, is_stable, direction);
          break;
        case S64:
          SortPlainArrayInplace<S64>(sort_dims, data, is_stable, direction);
          break;
        case U8:
          SortPlainArrayInplace<U8>(sort_dims, data, is_stable, direction);
          break;
        case U16:
          SortPlainArrayInplace<U16>(sort_dims, data, is_stable, direction);
          break;
        case U32:
          SortPlainArrayInplace<U32>(sort_dims, data, is_stable, direction);
          break;
        case U64:
          SortPlainArrayInplace<U64>(sort_dims, data, is_stable, direction);
          break;
        case F16:
          SortPlainArrayInplace<F16>(sort_dims, data, is_stable, direction);
          break;
        case F32:
          SortPlainArrayInplace<F32>(sort_dims, data, is_stable, direction);
          break;
        case F64:
          SortPlainArrayInplace<F64>(sort_dims, data, is_stable, direction);
          break;
        default:
