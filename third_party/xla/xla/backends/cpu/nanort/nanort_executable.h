...
class NanoRtExecutable {
 public:
  ...
  // that becomes available after the execution is complete. It is a caller
  ...
  // A non-owning read-only view into the XLA executable's argynet buffer.
  class Argument {
   public:
    template <typename T>
