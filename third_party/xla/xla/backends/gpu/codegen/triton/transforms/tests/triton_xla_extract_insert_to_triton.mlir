...
module {
  func.func @incompatible_tma_dynamic_offset_not_divisible_by_16_bytes(%arg0: tensor<4x8320xbf16>, %arg1: tensor<4x64x130xbf16>) -> tensor<4x64x130xbf16> {
    %0 = tt.get_program_id x : i32
    %1 = arith.extsi %0 : i32 to i64
    %2 = arith.index_castui %1 : i64 to index
    %3 = xla.apply_indexing #indexing_map(%2)
    %extracted_tile = triton_xla.extract %arg0[0, %3] [16, 16] [1, 1] {layout = array<i64: 1, 0>} : tensor<4x8320xbf16> to tensor<16x16xbf16>
    ...
    %inserted_tile = triton_xla.insert %4 into %arg1[0, %5, %6] [16, 1, 16] [1, 1, 1] {layout = array<i64: 2, 1, 0>} : tensor<16x1x16xbf16> into tensor<4x64x130xbf16>
