...
// Forward-declaration to avoid 'major' macro from GNU C Library conflicting
// with CudaComputeCapability::major member.
using GpuComputeCapability =
    std::variant<struct CudaComputeCapability, class RocmComputeCapability>;
}  // namespace stream_executor
