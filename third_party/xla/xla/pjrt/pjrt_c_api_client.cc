...
class PjRtCApiAsyncHostToDeviceTransferManager
 ...
 public:
  PjRtCApiAsyncHostToDeviceTransferManager(
      ...
      : client_(client), c_transfer_manager_(std::move(c_transfer_manager)) {}

  size_t buffer_count() const override { LOG(FATAL) << "unimplemented"; }

  PjRtDevice* device() const override { LOG(FATAL) << "unimplemented"; }
