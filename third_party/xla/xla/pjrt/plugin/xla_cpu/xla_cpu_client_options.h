...
#ifndef XLA_PJRT_PLUGIN_XLA_CPU_XLA_CPU_CLIENT_OPTIONS_H_
#define XLA_PJRT_PLUGIN_XLA_CPU_XLA_CPU_CLIENT_OPTIONS_H_
...
#endif  // XLA_PJRT_PLUGIN_XLA_CPU_XLA_CPU_CLIENT_OPTIONS_H_
