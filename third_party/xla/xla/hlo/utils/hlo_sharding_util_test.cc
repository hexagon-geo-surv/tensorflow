...
TEST(HloShardingUtilTest, GetFirstFreeDimForSortOperand1) {
  Shape shape = ShapeUtil::MakeShape(F32, {1, 8, 128, 128});
  HloSharding sharding = HloSharding::IotaTile({8, 1, 2, 16});
  EXPECT_FALSE(GetFirstFreeDimForSortOperand(shape, sharding, 0).has_value());
  EXPECT_FALSE(GetFirstFreeDimForSortOperand(shape, sharding, 1).has_value());
  EXPECT_EQ(GetFirstFreeDimForSortOperand(shape, sharding, 2), 1);
  EXPECT_EQ(GetFirstFreeDimForSortOperand(shape, sharding, 3), 2);
}

TEST(HloShardingUtilTest, GetFirstFreeDimForSortOperand2) {
  Shape shape = ShapeUtil::MakeShape(F32, {4, 8, 128, 128});
  HloSharding sharding = HloSharding::IotaTile({2, 2, 4, 16});
  EXPECT_EQ(GetFirstFreeDimForSortOperand(shape, sharding, 0), 1);
  EXPECT_EQ(GetFirstFreeDimForSortOperand(shape, sharding, 1), 0);
  EXPECT_EQ(GetFirstFreeDimForSortOperand(shape, sharding, 2), 1);
  EXPECT_EQ(GetFirstFreeDimForSortOperand(shape, sharding, 3), 2);
}

TEST(HloShardingUtilTest, GetFirstFreeDimForSortOperand3) {
...
TEST(HloShardingUtilTest, GetFirstFreeDimForSortOperandRankOne) {
...
TEST(HloShardingUtilTest, GetFirstFreeDimForSortOperandReplicated) {
