  ...
  switch (instruction->opcode()) {
    ...
    case HloOpcode::kRaggedAllToAll: {
      ...
      backendConfigAttributes.push_back(ConvertReplicaGroups(
          instruction, &symbol_table_, func_builder, /*emit_stablehlo=*/true));
    ...
    case HloOpcode::kAllGather: {
      ...
      attributes.push_back(ConvertReplicaGroups(
          all_gather, &symbol_table_, func_builder, /*emit_stablehlo=*/true));
    ...
    case HloOpcode::kAllReduce: {
      ...
      attributes.push_back(ConvertReplicaGroups(
          all_reduce, &symbol_table_, func_builder, /*emit_stablehlo=*/true));
