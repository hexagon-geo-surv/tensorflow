...
// TODO(agunjal): why layout{1, 0} is not same as {0, 1} stablehlo -> mhlo -> hlo?
...
// CHECK-NEXT:  %[[Arg_1_2:[^ ]+]] = token[] parameter(1)
// TODO(agunjal): why sharding needs to be remvoed? "sharding={{devices=[2,1]0,1}, {maximal device=0}}, metadata={.*}"
