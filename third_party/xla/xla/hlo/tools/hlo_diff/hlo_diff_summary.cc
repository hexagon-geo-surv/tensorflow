...
MainMatchedComputationResult FindMainMatchedComputation(
    const HloComputation* computation, const HloModule& module,
    const InstructionBimap& mapping, DiffSide side) {
...
SummarizeAllComputationsInGraph(
  ...
  for (const HloComputation* computation : module.computations()) {
    const MainMatchedComputationResult mmc =
        FindMainMatchedComputation(computation, module, mapping, side);
